Note : These are some custom scripts used in the [presentation version 1 ](https://zenodo.org/records/15308773) . In most cases offical (import/export) scripts from OME team is recommended.
