...
# -*- coding: utf-8 -*-
"""
Export image metadata and key-value annotations from a Dataset or Image list to a CSV file.
...
def run_script():
    client = scripts.client(
        "ImageToCSV.py",
        "Export image metadata and key-value pairs to CSV, with download link.",
